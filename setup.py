...
setup(
    ...
    description="Install All SKELETON",
    install_requires=REQUIREMENTS,
    license="MIT license",
    long_description=README + '\n\n' + HISTORY,
    include_package_data=True,
    keywords='pyarchops_SKELETON',
    packages=['pyarchops_SKELETON'],
    setup_requires=SETUP_REQUIREMENTS,
    test_suite='tests',
    tests_require=TEST_REQUIREMENTS,
    url='https://github.com/pyarchops/SKELETON',
    version=find_version('pyarchops_SKELETON', '__init__.py'),
    zip_safe=False,
)
